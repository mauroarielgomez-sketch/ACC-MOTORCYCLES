...
.agg2-card.open > .agg2-card-head > .agg2-chevron { transform: rotate(180deg); }
...
/* Without flex-shrink:0, a flex column with max-height+overflow squishes its
   children to fit instead of scrolling — that's what made domain rows render
   as unreadable slivers. */
.sm-children > .agg2-card { flex-shrink: 0; }
