...
def build_rdm(df):
    ...
    return {
        ...
        'clips_p': {'act': v("% NMV Clips",                      "Actual"), 'yoy': v("% NMV Clips",                      "YoY"), 'vsp': v("% NMV Clips",                      "vs Plan")},
        'afil_n':  {'act': v("# Afiliados",                      "Actual"), 'yoy': v("# Afiliados",                      "YoY"), 'vsp': v("# Afiliados",                      "vs Plan")},
        'afil_p':  {'act': v("% NMV Affiliates",                 "Actual"), 'yoy': v("% NMV Affiliates",                 "YoY"), 'vsp': v("% NMV Affiliates",                 "vs Plan")},
        'buybox':  {'act': v("% NMV Buy Box",                    "Actual"), 'yoy': v("% NMV Buy Box",                    "YoY"), 'vsp': v("% NMV Buy Box",                    "vs Plan")},
        'cbt':     {'act': v("CBT Penetration (%NMV)",           "Actual"), 'yoy': v("CBT Penetration (%NMV)",           "YoY"), 'vsp': v("CBT Penetration (%NMV)",           "vs Plan")},
        'bpckmi':  {'act': v("% BPC KMI",                        "Actual"), 'yoy': DASH,                                         'vsp': DASH},
        'kmi':     {'act': v("KMI Scrapping Coverage (%Visits)", "Actual"), 'yoy': DASH,                                         'vsp': DASH},
        'fbm':     {'act': v("% NSI FBM",                        "Actual"), 'yoy': v("% NSI FBM",                        "YoY"), 'vsp': v("% NSI FBM",                        "vs Plan")},
        'stk':     {'act': v("Stockouts (As % of FBM GMV)",      "Actual"), 'yoy': v("Stockouts (As % of FBM GMV)",      "YoY"), 'vsp': v("Stockouts (As % of FBM GMV)",      "vs Plan")},
        'prom':    {'act': v("% Promesas en VIP ≤2D",        "Actual"), 'yoy': v("% Promesas en VIP ≤2D",        "YoY"), 'vsp': v("% Promesas en VIP ≤2D",        "vs Plan")},
        'ben':     {'act': v("Benefits Meli Investment %",       "Actual"), 'yoy': v("Benefits Meli Investment %",       "YoY"), 'vsp': v("Benefits Meli Investment %",       "vs Plan")},
